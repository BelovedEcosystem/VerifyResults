(* E0_LLDUC_equations4.v
   File 4. Standalone. Stdlib only. Q and Z. No Reals.
   File 3 plus ledger identities from eta_504 / equations_11
   that do not require H or recs.
...
Theorem eis_ZB_5 : eis_ZB 5 == -264. Proof. vm_compute. reflexivity. Qed.
...
Theorem E4E6_is_E10_q1 :
  E4_q1 + E6_q1 == E10_q1
  /\ E4_q1 + E6_q1 == -264.
Proof. split; vm_compute; reflexivity. Qed.

Theorem five04_from_E4_and_E10 :
  inject_Z 504 == E4_q1 - E10_q1
  /\ inject_Z 504 == inject_Z 240 - inject_Z (-264).
Proof. split; vm_compute; reflexivity. Qed.

Theorem five04_in_units_of_24 :
  inject_Z 240 / inject_Z 24 + inject_Z 264 / inject_Z 24 == inject_Z 21
  /\ inject_Z 504 / inject_Z 24 == inject_Z 21
  /\ inject_Z 504 == inject_Z 24 * inject_Z 21.
...
Definition tau2 : Z := (-24)%Z.
Definition tau3 : Z := 252%Z.

Theorem tau_writings_of_504 :
  (10 * tau2 = -240)%Z
  /\ (2 * tau3 = 504)%Z.
Proof. split; vm_compute; reflexivity. Qed.

Definition mersenne6 : Z := (2^6 - 1)%Z.
Definition mersenne7 : Z := (2^7 - 1)%Z.
...
Theorem lam_gauge_atoms :
  (golay_d * mersenne7 = 1016)%Z
  /\ (2 * 504 + 8 = 1016)%Z
  /\ (8 * 127 = 1016)%Z.
Proof. repeat split; vm_compute; reflexivity. Qed.
...
Theorem eta_from_tau3 :
  eta == inject_Z (2 * tau3) * pico.
Proof. vm_compute. reflexivity. Qed.

Theorem eta_from_24_21 :
  eta == inject_Z 24 * inject_Z 21 * pico.
Proof. vm_compute. reflexivity. Qed.

Theorem eta_from_E4_minus_E10 :
  eta == (E4_q1 - E10_q1) * pico.
Proof. vm_compute. reflexivity. Qed.
...
Theorem tail_cancels :
  forall h : Q, h - a_star_of h == eta.
Proof. intros h. unfold a_star_of. ring. Qed.

Theorem eta_times_grid :
  eta * inject_Z ((10 ^ 12)%Z) == inject_Z 504.
Proof. vm_compute. reflexivity. Qed.
...
Proof. intros h. rewrite tail_cancels. apply eta_times_grid. Qed.
...
Theorem a_star_lowest_terms :
  Z.gcd 2767620870254063 125000000000 = 1%Z.
Proof. vm_compute. reflexivity. Qed.

Theorem a_star_mersenne_tail :
  (254063 = 2 * 127 * 1000 + 63)%Z
  /\ (2032504 = 2 * 1016 * 1000 + 504)%Z.
Proof. split; vm_compute; reflexivity. Qed.
...
Theorem width_factorizations :
  (26491 = 59 * 449)%Z
  /\ (238419 = 9 * 59 * 449)%Z
  /\ (26484 = 12 * 2207)%Z
  /\ (1907352 = 72 * (12 * 2207 + 7))%Z
  /\ (1907352 = 8 * 3 * 26491)%Z.
Proof. repeat split; vm_compute; reflexivity. Qed.
